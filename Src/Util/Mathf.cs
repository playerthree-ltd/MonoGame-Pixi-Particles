...
//adapted from Nez - https://github.com/prime31/Nez/blob/ecca9aeb10336cce2705588198e3e51e4d397fb8/Nez.Portable/Math/Mathf.cs
namespace P.Particles
{
    public static class Mathf
    {
        ...
        /// <summary>
        /// Random number generation of floating point numbers
        /// </summary>
        /// <returns>A float greater than 0 and less than 1.0 </returns>
        ...
        /// <summary>
        /// Random number generation of floating point numbers within range
        /// </summary>
        /// <returns>A float greater than min and less than max </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Random number generation of integers
        /// </summary>
        /// <returns>An integer in range min ... max, upto and including max</returns>
        ...
        /// </summary>
        /// <returns>An integer in range min ... max </returns>
        /// <param name="n">N - The value to round.</param>
        /// <param name="decimalPlaces">DecimalPlaces - The number of decimal places to round this number to.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float RoundDecimal(float number, int decimalPlaces = 0)
        {
            float decimals = Pow(10, decimalPlaces);
            return Round(Floor(number * decimals) / decimals);
        }
